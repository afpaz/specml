 ...
 * </p>
 * <ul>
 *   <li>{@link ca.ets.sofeess.specml.impl.TraceImpl#getBase_Dependency <em>Base Dependency</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TraceImpl extends MinimalEObjectImpl.Container implements Trace {
	...
	protected EClass eStaticClass() {
		return SpecMLPackage.Literals.TRACE;
	}
		...
		if (base_Dependency != null && base_Dependency.eIsProxy()) {
			...
			if (base_Dependency != oldBase_Dependency) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SpecMLPackage.TRACE__BASE_DEPENDENCY, oldBase_Dependency, base_Dependency));
			}
		}
	...
	public void setBase_Dependency(Dependency newBase_Dependency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpecMLPackage.TRACE__BASE_DEPENDENCY, oldBase_Dependency, base_Dependency));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 SpecValidator.TRACE__DEPENDENCY_CLIENT_IS_UNIQUE,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 SpecValidator.DIAGNOSTIC_SOURCE,
						 SpecValidator.TRACE__DEPENDENCY_SUPPLIER_IS_UNIQUE,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 SpecValidator.DIAGNOSTIC_SOURCE,
						 SpecValidator.TRACE__REQUIREMENT_CLIENT,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SpecMLPackage.TRACE__BASE_DEPENDENCY:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case SpecMLPackage.TRACE___DEPENDENCY_CLIENT_IS_UNIQUE__DIAGNOSTICCHAIN_MAP:
				return DependencyClientIsUnique((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case SpecMLPackage.TRACE___DEPENDENCY_SUPPLIER_IS_UNIQUE__DIAGNOSTICCHAIN_MAP:
				return DependencySupplierIsUnique((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case SpecMLPackage.TRACE___REQUIREMENT_CLIENT__DIAGNOSTICCHAIN_MAP:
