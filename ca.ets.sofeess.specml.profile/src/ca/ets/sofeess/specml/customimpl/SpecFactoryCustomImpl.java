...
import ca.ets.sofeess.specml.impl.SpecFactoryImpl;

public class SpecFactoryCustomImpl extends SpecFactoryImpl implements SpecFactory {

	@Override
	public PropertyBasedStatement createPropertyBasedStatement() {
		return new PropertyBasedStatementCustomImpl();
	}
