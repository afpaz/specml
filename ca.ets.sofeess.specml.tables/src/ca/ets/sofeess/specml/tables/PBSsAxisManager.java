...
public class PBSsAxisManager
		extends AbstractStereotypedElementUMLSynchronizedOnFeatureAxisManager<PropertyBasedStatement> {

	@Override
	public boolean canCreateAxisElement(String elementId) {
		return "ca.ets.sofeess.specml.PropertyBasedStatement".equals(elementId);
	}

	@Override
	protected PropertyBasedStatement getStereotypeApplication(Element element) {
		return UMLUtil.getStereotypeApplication(element, PropertyBasedStatement.class);
	}
	...
	@Override
	protected Element getStereotypeBaseElement(PropertyBasedStatement stereotypeApplication) {
