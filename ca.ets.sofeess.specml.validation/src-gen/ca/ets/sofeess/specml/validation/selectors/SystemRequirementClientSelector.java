 ...
 * @generated
 */
public class SystemRequirementClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "SystemRequirement"); //$NON-NLS-1$
	}
}
