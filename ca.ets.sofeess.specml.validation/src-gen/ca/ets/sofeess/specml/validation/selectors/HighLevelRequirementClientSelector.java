 ...
 * @generated
 */
public class HighLevelRequirementClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "HighLevelRequirement"); //$NON-NLS-1$
	}
}
