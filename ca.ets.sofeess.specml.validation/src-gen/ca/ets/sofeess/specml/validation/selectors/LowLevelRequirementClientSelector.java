 ...
 * @generated
 */
public class LowLevelRequirementClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "LowLevelRequirement"); //$NON-NLS-1$
	}
}
