 ...
 * @generated
 */
public class TimedDurationConstraintClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "TimedDurationConstraint"); //$NON-NLS-1$
	}
}
