 ...
 * @generated
 */
public class TimedDomainClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "TimedDomain"); //$NON-NLS-1$
	}
}
